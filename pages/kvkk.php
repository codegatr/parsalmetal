...
$pageMetaTitle = ($pg['meta_title'] ?? '') ?: 'KVKK Aydınlatma Metni - ' . getSetting('site_title');
  ...
  <!-- Varsayılan bölümler -->
        ...
        <div class="legal-section">
          ...
          <div class="legal-section-body">
            <h3 class="legal-section-title">1. Veri Sorumlusu</h3>
            <div class="legal-section-content"><p>Bu aydınlatma metni, <strong>6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK)</strong> kapsamında veri sorumlusu sıfatıyla hazırlanmıştır.</p><p>Şirketimiz, kişisel verilerinizi hukuka ve dürüstlük kurallarına uygun, doğru ve güncel, belirli açık ve meşru amaçlar için işlemektedir.</p></div>
          </div>
        </div>
        <div class="legal-section">
          <div class="legal-section-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c0392b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4 M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
          </div>
          <div class="legal-section-body">
            <h3 class="legal-section-title">2. İşlenen Kişisel Veriler</h3>
            <div class="legal-section-content"><p>Aşağıdaki kişisel veriler işlenmektedir:</p><ul><li><strong>Kimlik Bilgileri:</strong> Ad, soyad, TC kimlik numarası</li><li><strong>İletişim Bilgileri:</strong> E-posta, telefon, adres</li><li><strong>İşlem Bilgileri:</strong> Teklif talepleri, iletişim formu kayıtları</li><li><strong>Teknik Bilgiler:</strong> IP adresi, çerez verileri, site kullanım bilgileri</li></ul></div>
          </div>
        </div>
        <div class="legal-section">
          <div class="legal-section-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c0392b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9 M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
          </div>
          <div class="legal-section-body">
            <h3 class="legal-section-title">3. İşleme Amaçları</h3>
            <div class="legal-section-content"><ul><li>Teklif ve sipariş süreçlerinin yürütülmesi</li><li>Müşteri ilişkileri ve iletişimin sağlanması</li><li>Hizmet kalitesinin iyileştirilmesi</li><li>Yasal yükümlülüklerin yerine getirilmesi</li><li>İş geliştirme ve pazarlama faaliyetleri (açık rıza ile)</li></ul></div>
          </div>
        </div>
        <div class="legal-section">
          <div class="legal-section-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c0392b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75"/></svg>
          </div>
          <div class="legal-section-body">
            <h3 class="legal-section-title">4. Veri Aktarımı</h3>
            <div class="legal-section-content"><p>Kişisel verileriniz; hizmet sunumu amacıyla iş ortaklarımız, yetkili kamu kurum ve kuruluşları ile yasal düzenlemeler çerçevesinde paylaşılabilir. Açık rızanız olmaksızın üçüncü taraflara aktarılmaz.</p></div>
          </div>
        </div>
        <div class="legal-section">
          <div class="legal-section-icon">
          ...
          <div class="legal-section-body">
            <h3 class="legal-section-title">5. Haklarınız</h3>
            <div class="legal-section-content"><p>KVKK'nın 11. maddesi kapsamında aşağıdaki haklara sahipsiniz:</p><ul><li>Kişisel verilerinizin işlenip işlenmediğini öğrenme</li><li>İşlenmişse buna ilişkin bilgi talep etme</li><li>Düzeltilmesini veya silinmesini isteme</li><li>Aktarıldığı üçüncü kişileri öğrenme</li><li>Otomatik sistemler vasıtasıyla aleyhinize bir sonucun ortaya çıkmasına itiraz etme</li></ul></div>
          </div>
        </div>
        <div class="legal-section">
          <div class="legal-section-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c0392b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          </div>
          <div class="legal-section-body">
            <h3 class="legal-section-title">6. Başvuru Yöntemi</h3>
            <div class="legal-section-content"><p>KVKK kapsamındaki haklarınızı kullanmak için <strong>info@parsal.com.tr</strong> adresine e-posta gönderebilir veya şirket adresimize yazılı başvuruda bulunabilirsiniz. Başvurularınız en geç <strong>30 gün</strong> içinde sonuçlandırılır.</p></div>
          </div>
        </div>
  <?php endif; ?>
