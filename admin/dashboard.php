...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:24px">
  <div class="card">
    <div class="card-header"><div class="card-title">Son Teklif Talepleri</div><a href="/admin/talepler.php" class="btn btn-sm btn-secondary">Tumunu Gor</a></div>
  ...
  <div class="card">
    <div class="card-header"><div class="card-title">Son Iletisim Mesajlari</div><a href="/admin/mesajlar.php" class="btn btn-sm btn-secondary">Tumunu Gor</a></div>
    <div class="table-wrap">
      <table class="admin-table">
