...
<div class="stats-grid">
  <div class="stat-card">
    <div class="stat-icon red"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/></svg></div>
    <div><div class="stat-num"><?= $counts['products'] ?></div><div class="stat-lbl">Aktif Ürün</div></div>
  </div>
  <div class="stat-card">
    <div class="stat-icon blue"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg></div>
    <div><div class="stat-num"><?= $counts['quotes'] ?></div><div class="stat-lbl">Teklif Talebi</div></div>
  </div>
  <div class="stat-card">
    <div class="stat-icon green"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg></div>
    <div><div class="stat-num"><?= $counts['contacts'] ?></div><div class="stat-lbl">İletişim Mesaji</div></div>
  </div>
  <div class="stat-card">
    <div class="stat-icon yellow"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:24px">
  <div class="card">
    <div class="card-header"><div class="card-title">Son Teklif Talepleri</div><a href="/admin/talepler.php" class="btn btn-sm btn-secondary">Tümünu Gor</a></div>
    <div class="table-wrap">
      <table class="admin-table">
        ...
        <tbody>
          ...
          <?php endforeach; ?>
          <?php if (empty($latestQuotes)): ?><tr><td colspan="4" style="text-align:center;color:#999;padding:24px">Henuz talep yok.</td></tr><?php endif; ?>
        </tbody>
      </table>
    </div>
  </div>
  <div class="card">
    <div class="card-header"><div class="card-title">Son İletişim Mesajlari</div><a href="/admin/mesajlar.php" class="btn btn-sm btn-secondary">Tümünu Gor</a></div>
    <div class="table-wrap">
      <table class="admin-table">
        ...
        <tbody>
          ...
          <?php endforeach; ?>
          <?php if (empty($latestContacts)): ?><tr><td colspan="3" style="text-align:center;color:#999;padding:24px">Henuz mesaj yok.</td></tr><?php endif; ?>
        </tbody>
      </table>
    </div>
  </div>
...
<div style="margin-top:24px">
  <h2 style="font-size:15px;font-weight:700;margin-bottom:16px">Hızlı Erisim</h2>
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:12px">
    <?php $shortcuts = [
      ['href'=>'/admin/slider.php','icon'=>'M8 3H5a2 2 0 00-2 2v3m18 0V5a2 2 0 00-2-2h-3M8 21H5a2 2 0 01-2-2v-3m18 0v3a2 2 0 01-2 2h-3','label'=>'Slider'],
      ['href'=>'/admin/urunler.php?action=add','icon'=>'M12 4v16m8-8H4','label'=>'Ürün Ekle'],
      ...
      ['href'=>'/admin/guncelleme.php','icon'=>'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9','label'=>'Güncelleme'],
