...
$menu = [
  ...
  ['sep'=>'ICERIK'],
  ['mod'=>'slider','icon'=>'M8 3H5a2 2 0 00-2 2v3m18 0V5a2 2 0 00-2-2h-3M8 21H5a2 2 0 01-2-2v-3m18 0v3a2 2 0 01-2 2h-3','label'=>'Slider Yonetimi'],
  ['mod'=>'urunler','icon'=>'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10','label'=>'Urunler'],
  ...
  ['sep'=>'TALEPLER'],
  ['mod'=>'talepler','icon'=>'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z','label'=>'Teklif Talepleri','badge'=>$newQuotes],
  ['mod'=>'mesajlar','icon'=>'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z','label'=>'Iletisim Mesajlari','badge'=>$newContacts],
  ['sep'=>'SISTEM'],
  ...
  ['mod'=>'guncelleme','icon'=>'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15','label'=>'Guncelleme'],
...
<aside class="sidebar" id="sidebar">
  <div class="sb-logo">
    ...
    <div class="sb-logo-text">
      <div class="site-name"><?= htmlspecialchars($siteTitle) ?></div>
  ...
  <nav style="padding:12px 0;flex:1">
    <?php foreach ($menu as $item): ?>
      ...
      <?php else: ?>
      <ul class="sb-nav"><li>
        <a href="/admin/<?= $item['mod'] ?>.php" class="<?= $currentMod === $item['mod'] ? 'active' : '' ?>">
          <svg class="sb-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="<?= $item['icon'] ?>"/></svg>
          <?= $item['label'] ?>
  ...
  <div class="sb-bottom">
    <ul class="sb-nav"><li>
      <a href="/admin/logout.php" style="color:rgba(255,255,255,.4)">
        <svg class="sb-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9"/></svg>
        Cikis Yap
      </a>
    </li></ul>
    <div style="padding:10px 14px;font-size:11px;color:rgba(255,255,255,.2)">v<?= APP_VERSION ?? '1.0.0' ?> &bull; CODEGA</div>
  </div>
</aside>
